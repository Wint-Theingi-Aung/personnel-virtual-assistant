...
const App = () => {
    ...
    const handleSendMessage = async (e?: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const systemInstruction = `Role: သင်သည် Assistant Partner ဖြစ်သည်။ ဝန်ထမ်းများ၏ မေးခွန်းများကို ပေးထားသော PDF စာအုပ်ပါ အချက်အလက်များကိုသာ အခြေခံ၍ မြန်မာဘာသာ (Unicode) ဖြင့် ဖြေကြားပေးရန် ဖြစ်သည်။
